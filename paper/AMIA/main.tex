...
Second, overall performance of hidden Markov model is better than general Markov model in both type of sequences. We observed that hidden Markov model achieved near-human accuracy to categories the sequences of behavior codes. This means that hidden states capture the propagated information passes through the sequence for determining final outcome. 
