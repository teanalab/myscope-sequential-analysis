...
\title{Predicting Success of Clinical Interviews via Sequential Analysis of Patient-Provider Interactions}
...
\noindent{\bf Abstract}
\textit{The problem of analyzing temporally ordered sequences of past events to make predictions related to the observed sequence of events arises in many data analytics scenarios in healthcare informatics. In this paper, we focus on the analysis of patient-provider communication sequences in the context of clinical interviews and propose the methods for identifying the most effective communication sequences for triggering a particular type of patient response and dynamically predicting this type of response based on observed interactions. Such analysis is necessary to facilitate the development of effective interventions to address many public health conditions, such as childhood obesity. Our proposed probabilistic method for predicting a patient behavioral response in communication sequences can be utilized with both Markov chains or Hidden Markov Models. It achieved 75.32\% and 79.89\% F-measure for normal sequences and 97.36\% and 96.99\% F-measure for alternate sequences using first and second order Markov chain and Hidden Markov Model, respectively. Our results indicate that individual short length patient-provider communication sequences are highly indicative of the progression and trajectory of clinical interviews and can be used to predict the overall success of motivational interviews. Our results have broad implications for qualitative public health research by providing a formal mechanism to facilitate the development of more effective behavioral interventions.}
