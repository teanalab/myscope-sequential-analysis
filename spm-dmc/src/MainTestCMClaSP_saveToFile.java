...
public class MainTestCMClaSP_saveToFile {
    ...
    public static void main(String[] args) throws IOException {
     ...
     // if you set the following parameter to true, the sequence ids of the sequences where
        ...
        double relativeSupport = sequenceDatabase.loadFile("input/contextPrefixSpan.txt", support);
        ...
        algorithm.runAlgorithm(sequenceDatabase, keepPatterns, verbose, "output/output_cmclasp.txt",outputSequenceIdentifiers);
