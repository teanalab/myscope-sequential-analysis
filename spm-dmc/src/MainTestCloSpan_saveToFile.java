...
public class MainTestCloSpan_saveToFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        sequenceDatabase.loadFile("input/contextPrefixSpan.txt", support);
        ...
        algorithm.runAlgorithm(sequenceDatabase, keepPatterns, verbose, "output/output_clospan.txt", outputSequenceIdentifiers);
