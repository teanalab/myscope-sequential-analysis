...
* When Undersampling is used for data balancing (\# hidden units = 15, batch size = 8, embedding dimension = 44, learning rate = 0.00005, minimum change = 0.0010)
...
* When Oversampling is used for data balancing (\# hidden units = 15, batch size = 55, embedding dimension = 44, learning rate = 0.00008, minimum change = 0.0005)
